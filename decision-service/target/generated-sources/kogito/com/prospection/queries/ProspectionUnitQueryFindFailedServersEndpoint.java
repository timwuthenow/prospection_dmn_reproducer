...
@Path("/find-failed-servers")
public class ProspectionUnitQueryFindFailedServersEndpoint {

    @javax.inject.Inject
    RuleUnit<com.prospection.queries.ProspectionUnit> ruleUnit;

    public ProspectionUnitQueryFindFailedServersEndpoint() {
    }

    public ProspectionUnitQueryFindFailedServersEndpoint(RuleUnit<com.prospection.queries.ProspectionUnit> ruleUnit) {
    ...
    public List<com.prospection.model.Server> executeQuery(com.prospection.queries.ProspectionUnit unitDTO) {
        ...
        List<com.prospection.model.Server> response = instance.executeQuery(ProspectionUnitQueryFindFailedServers.class);
        instance.dispose();
        return response;
    }
