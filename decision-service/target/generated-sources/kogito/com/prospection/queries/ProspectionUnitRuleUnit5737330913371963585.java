...
public class ProspectionUnitRuleUnit5737330913371963585 extends AbstractRuleUnit<com.prospection.queries.ProspectionUnit> {
    ...
    public ProspectionUnitRuleUnit5737330913371963585() {
        super(com.prospection.queries.ProspectionUnit.class.getCanonicalName());
    }

    @Override
    public ProspectionUnitRuleUnitInstance5737330913371963585 internalCreateInstance(com.prospection.queries.ProspectionUnit data) {
        ReteEvaluator reteEvaluator = new RuleUnitExecutorImpl(ruleBase);
        return new ProspectionUnitRuleUnitInstance5737330913371963585(this,
                                                                      data,
                                                                      reteEvaluator);
    }
}
