...
@Path("/find-passed-servers")
public class ProspectionUnitQueryFindPassedServersEndpoint {

    @javax.inject.Inject
    RuleUnit<com.prospection.queries.ProspectionUnit> ruleUnit;

    public ProspectionUnitQueryFindPassedServersEndpoint() {
    }

    public ProspectionUnitQueryFindPassedServersEndpoint(RuleUnit<com.prospection.queries.ProspectionUnit> ruleUnit) {
    ...
    public List<com.prospection.model.Server> executeQuery(com.prospection.queries.ProspectionUnit unitDTO) {
        ...
        List<com.prospection.model.Server> response = instance.executeQuery(ProspectionUnitQueryFindPassedServers.class);
        instance.dispose();
        return response;
    }
